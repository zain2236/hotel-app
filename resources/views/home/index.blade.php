               ...
               <div class="col-lg-6">
                  <div class="booking-form">
                     ...
                     <form action="{{ route('rooms.public') }}" method="GET">
                        <div class="row g-3">
                           <div class="col-md-6">
                              <label class="form-label" style="color: var(--dark-color); font-weight: 500;">Check In</label>
                              <input type="date" class="form-control" name="check_in" value="{{ request('check_in') }}" min="{{ date('Y-m-d') }}">
                           </div>
                           <div class="col-md-6">
                              <label class="form-label" style="color: var(--dark-color); font-weight: 500;">Check Out</label>
                           ...
                           <div class="col-md-6">
                              <label class="form-label" style="color: var(--dark-color); font-weight: 500;">Guests</label>
                           ...
                           <div class="col-md-6">
                              <label class="form-label" style="color: var(--dark-color); font-weight: 500;">&nbsp;</label>
